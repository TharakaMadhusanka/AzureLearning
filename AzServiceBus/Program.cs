...
var servicebusnamespace = "tharakaservicebus.servicebus.windows.net";
var queueName = "tharakaqueue";
...
ServiceBusClient client = new(servicebusnamespace, new DefaultAzureCredential(options));
